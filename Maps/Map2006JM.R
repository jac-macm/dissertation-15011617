...
# Load required packages to work with SPARQL queries, handle shapefiles, transform 
# data and create the map.
...
# SPARQL query to retrieve data zones and SIMD rank values for 2020
...
WHERE {
    ?indicator qb:dataSet data:scottish-index-multiple-deprivation;
              <http://statistics.gov.scot/def/dimension/simdDomain> <http://statistics.gov.scot/def/concept/simd-domain/housing>;
              mp:rank ?SIMDrank;
              sdmxd:refPeriod <http://reference.data.gov.uk/id/year/2006> ;
              sdmxd:refArea ?area.
...
unzip("C:/Users/Jac/Documents/BSc Computing Year 4 Pt2/Dissertation/RTest/LAD.zip")

# Load shapefile into R as spatial polygons data frame
boundary <- readOGR(dsn="C:/Users/Jac/Documents/BSc Computing Year 4 Pt2/Dissertation/RTest", layer="Local_Authority_Districts_December_2017_Ultra_Generalised_Clipped_Boundaries_in_United_Kingdom_WGS84")
